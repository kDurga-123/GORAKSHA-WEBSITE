...
import { getAllCows } from '../Redux/CowReducer/Action.js'; // Adjust the relative path as needed
...
function History() {
    ...
    return (
        <div>
            ...
            <div className="cows">
                <div>
                    <img className="history" src="https://img.freepik.com/premium-photo/rock-paintings-prehistoric-evidence-ancient-age_31965-89702.jpg?w=900"/>
